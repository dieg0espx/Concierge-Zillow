...
export function PropertiesListClient({ initialProperties, managers, assignments }: PropertiesListClientProps) {
  ...
  useEffect(() => {
    // Format the initial properties data
    const formattedData = initialProperties.map((prop) => {
      ...
      return {
        ...
        show_nightly_rate: prop.show_nightly_rate || false,
        custom_nightly_rate: prop.custom_nightly_rate || null,
        show_purchase_price: prop.show_purchase_price || false,
        custom_purchase_price: prop.custom_purchase_price || null,
      }
    })
